      ...
      <form onSubmit={saveProfile} className="rounded-xl2 border border-ink/5 dark:border-paper/10 bg-white dark:bg-ink-light p-6 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <input disabled value={user.email} className="w-full rounded-lg border border-ink/10 dark:border-paper/20 bg-ink/5 dark:bg-paper/5 px-3 py-2 text-sm text-ink/50 dark:text-paper/50" />
          </div>
        </div>
