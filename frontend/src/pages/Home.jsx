            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = 'https://images.unsplash.com/photo-1530866495561-507c9faab2ed?auto=format&fit=crop&w=700&q=80';
                }}
            ...
            >
              <div className="relative h-44 overflow-hidden bg-slate-900">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = 'https://images.unsplash.com/photo-1514222134-b57cbb8ce073?auto=format&fit=crop&w=1000&q=80';
                  }}
            ...
            >
              <div className="relative h-48 overflow-hidden bg-slate-900">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = 'https://images.unsplash.com/photo-1530866495561-507c9faab2ed?auto=format&fit=crop&w=1000&q=80';
                  }}
                  className="h-full w-full object-cover transition duration-500 group-hover:scale-105"
                />
